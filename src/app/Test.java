...
public class Test {
    ...
    public static void testSubscribtionWithRequest() {
        MessageDataBase messageDataBase = MessageDataBase.getInstance();
        messageDataBase.publishMessage("@arthur", "un grand message #big #message");
        RequestFactory factory = new RequestFactory();
        Request request = factory.createsRequest(RequestMaker.getRequest("SUBSCRIBE author:@arthur",""));
        System.out.println(request.getResponse());
        SUBSCRIBERequest subscribeRequest = (SUBSCRIBERequest) request;
        System.out.println(subscribeRequest.getResponse());


        ConcurrentLinkedQueue<Message> sub1 = new ConcurrentLinkedQueue<>();
        subscribeRequest.setQueue(sub1);
        subscribeRequest.execute();
        messageDataBase.publishMessage("@arthur", "un grand message #big #message");

        System.out.println(Subscription.getInstance().toString());
